...
$('#play-video').on('click', function(e){
  ...
  $("#video-overlay").append('<iframe width="853" height="416" src="https://www.youtube.com/embed/E8z-pM3lmUc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
});
...
$('#message_mail').on("submit", function (e) {

	e.preventDefault();

	var SendName  = $("#mes-name").val(),
	    SendEmail = $("#mes-email").val(),
	    SendMsg   = $("#mes-text").val();  
